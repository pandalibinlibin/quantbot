"""
Backtest API routes - Historical backtesting

Scope:
- Only affects the backtest frontend page, does not affect other pages
- Uses signals already generated by Update Data
- Completely independent from Run Signal
- Does not affect live portfolio state
